...
`);
		...
		$('#save').on('click', function(e) {
			...
			if (userFirstName.length === 0){
					userFeedback += '<h4 class="feedback">Please enter a First Name.</h4>';
					$('h3').append(userFeedback);
			} else if (userLastName.length === 0){
					userFeedback += '<h4 class="feedback">Please enter a Last Name.</h4>';
					$('h3').append(userFeedback);
			} else if (userEmail.length === 0){
					userFeedback += '<h4 class="feedback">Please enter an email.</h4>';
					$('h3').append(userFeedback);
			} else if(!render.validateEmail(userEmail)){
				userFeedback += '<h4 class="feedback">Please enter a valid email.</h4>';
				$('h3').append(userFeedback);
			} else if (userPassword.length === 0){
				userFeedback += '<h4 class="feedback">Please enter a password.</h4>';
				$('h3').append(userFeedback);
			} else {
...
`);
		...
		$('#submit').on('click', function(e) {
			...
			if (surveyName.length === 0){
					userFeedback += '<h4 class="feedback survey">Enter a survey name.</h4>';
					$('li.user-feedback').prepend(userFeedback);
			} else if (surveyDescription.length === 0){
					userFeedback += '<h4 class="feedback survey">Enter a description.</h4>';
					$('li.user-feedback').prepend(userFeedback);
			} else if (surveyItem1.length === 0){
					userFeedback += '<h4 class="feedback survey">Enter required item.</h4>';
					$('li.user-feedback').prepend(userFeedback);
			} else if (surveyItem2.length === 0){
					userFeedback += '<h4 class="feedback survey">Enter required item.</h4>';
					$('li.user-feedback').prepend(userFeedback);
			} else if (surveyExpiration.length === 0){
					userFeedback += '<h4 class="feedback survey">Enter expiration date.</h4>';
					$('li.user-feedback').prepend(userFeedback);
			} else {
				$('.survey').empty();
